    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h2 className="text-xl font-bold mb-4">CareerCompass</h2>
            <p className="text-gray-400 mb-4">
              Guiding your career journey with expert resources, mentorship, and opportunities.
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  123 Career Street, Bangalore, Karnataka, India
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@careercompass.in</span>
              </li>
            </ul>
          </div>
        </div>
